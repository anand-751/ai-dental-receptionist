...
### Changing Call Duration
Edit `src/App.tsx`:
```javascript
const CALL_DURATION = 120; // Change 120 to desired seconds
```

### Adjusting Speech Rate
Edit speech synthesis in `src/App.tsx`:
```javascript
utterance.rate = 1;    // Speed (0.5 = slow, 1 = normal, 2 = fast)
utterance.pitch = 1;   // Pitch (0.5 = low, 1 = normal, 2 = high)
...
```
🎙️ User speaks: "Hi, I want to book an appointment"
📝 Transcribed: "Hi, I want to book an appointment"
🤖 Intent: booking
🔊 AI Response: "Sure! Here are available slots..."
👥 Response spoken automatically
⏱️ Total: ~4 seconds
```

### With Interruption
```
🎙️ User: "Can you tell me... wait, actually, what's the price?"
📝 Auto-detects as new intent (pricing)
🤖 Intent: pricing
🔊 AI: "Our treatments are competitively priced..."
```
...
A: Yes, use the "Send Text" button to type messages manually.

**Q: Does it work on mobile?**
A: Yes, but speech recognition works best on Android Chrome. iOS has limitations.

**Q: Is my voice recorded?**
A: No, only the text transcription is stored temporarily (2 mins).

**Q: Can I change the AI voice?**
A: This uses system text-to-speech, so it depends on system settings.

**Q: What if there's background noise?**
A: Speak louder and more clearly. Try a quieter location.

**Q: Can I pause and resume?**
A: The session is continuous. You can pause speaking by stopping the microphone.
...
3. ✅ Test with an enquiry
4. ✅ Try booking an appointment
5. ✅ Try rescheduling
6. ✅ Verify 2-minute timer works
